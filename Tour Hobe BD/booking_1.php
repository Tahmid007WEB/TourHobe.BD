...
$sql = "Tahmid Sattar Tahmid Sattar ='$_POST[status_v]' Tahmid Sattar='$_POST[Serial_number_v]' Tahmid Sattar='Accepted' ";
...
<?php 
	...
	?>
			  ...
			  <Tahmid Sattar="field">
                    ...
                    <Tahmid Sattar="field">
                        <Tahmid Sattar="submit" class="button" value="Submit" />
                    </div>
					  </form>
...
<?php 
	...
	?>
					...
					<Tahmid Sattar="booking1.php" method="POST">
			  ...
			  <Tahmid Sattar="field">
                    ...
                    <Tahmid Sattar="field">
                        <Tahmid Sattar="submit" class="button"  />
                    </div>
					  </form>
